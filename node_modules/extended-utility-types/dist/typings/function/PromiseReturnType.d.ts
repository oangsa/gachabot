...
declare type Resolved<T> = T extends Promise<infer U> ? Resolved<U> : T;
/**
 ...
 * ```
 */
export declare type PromiseReturnType<T extends FunctionLike<Promise<unknown>>> = Resolved<ReturnType<T>>;
export {};
