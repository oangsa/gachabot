declare type Extract<T> = T extends `${infer F}{${infer P}}${infer R}` ? R extends `/${infer R}` ? {
 ...
 * ```
 */
export declare type PathParameters<S extends string> = string extends S ? Record<string, string> : Extract<S>;
export {};
