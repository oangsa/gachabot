declare type Permutation<T, K = T> = [T] extends [never] ? [] : K extends K ? [K, ...Permutation<Exclude<T, K>>] : never;
/**
 ...
 * ```
 */
export declare type Permutate<T> = Permutation<T extends readonly unknown[] ? T[number] : T>;
export {};
