declare type MapArray<T extends readonly unknown[]> = {
    [K in {
        [K in keyof T]: K;
    }[number]]: T[K];
};
 ...
 * ```
 */
export declare type RecordOf<T> = T extends PropertyKey ? {
    [K in T]: K;
} : T extends readonly unknown[] ? MapArray<T> : T extends Record<PropertyKey, unknown> ? T : never;
export {};
