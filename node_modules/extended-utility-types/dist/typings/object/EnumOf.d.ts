 ...
 * ```
 */
export declare type EnumOf<T extends readonly unknown[], U extends string | number = number> = Includes<[
    string,
    number
], U> extends true ? Freeze<Invert<RecordOf<T>>, U> : never;
export {};
